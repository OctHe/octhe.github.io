...
@headitem              @tab        KDE         @tab       GNOME       @tab         xfce         @tab    LXQT      
...
@item  Windows manager @tab        KWin        @tab    gnome-shell    @tab        xfwm4         @tab    Openbox   
...
@item      Editor      @tab        Kate        @tab gnome-text-editor @tab       Mousepad       @tab       -      
